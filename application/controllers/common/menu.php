        ...
        public function mainMenu($active = false)
        {
            ...
            if($menu_list){
                foreach ($menu_list as $key => $menu) {
                    ...
                    $data['menu_list'][$key]['title'] = $menu['title'];
                    $data['menu_list'][$key]['url'] = $menu['url'];
                    $data['menu_list'][$key]['class'] = '';

                    if($active == 'desktop' && $this->isActive($menu['url'])){
                        $data['menu_list'][$key]['class'] = 'class="d-menu-active"';
                    }
                    else if($active == 'mobile' && $this->isActive($menu['url'])){
